...
현재 DB 파일은 인증 vendor의 `auth` schema와 `business`의 workspace/member, BE-04 계정·초대·설정, BE-05 명령 receipt·감사·outbox, BE-06 dispatch·Context profile 무효화, BE-07 원문·unit revision, BE-08 Context, BE-09 Task, BE-10 Calendar, BE-12 판단 요청·불변 run, BE-13 제안·노출·피드백, BE-14 추출 후보 테이블을 만든다. 운영 DB에는 아직 적용하지 않았다.
