...
| CORE-11 | P4 | VERIFIED | 자유 기록에서 관리 항목 추출 계약 | CORE-08, CORE-10 |
...
| BE-11 | P3 | VERIFIED | 위키·문서 공통 draft/revision 엔진 | BE-05, FE-02 |
...
| BE-17 | P6 | IMPLEMENTED | 선택적 모델 정제 adapter·비용·실패 격리 | BE-16, BE-06, CORE-15 |
