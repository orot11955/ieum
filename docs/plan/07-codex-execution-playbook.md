...
현재 준비된 BE-01·FE-01·QA-02 중 사용자 구현 지시 범위에 맞는 카드부터 진행하라.
CORE-16은 docs/evidence/core-16.md의 재개 조건이 충족되기 전 평가 완료로 표시하지 마라.
