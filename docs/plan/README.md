...
BASE-01–03, CORE-01–15, BE-01–05는 VERIFIED다. BE-07은 로컬 구현·검증 후 Linux CI 확인 전인 IMPLEMENTED다. **CORE-16은 FE-14·FE-16과 허용된 실제 기록·holdout이 준비될 때 재개한다.** 다음 서버 카드는 BE-07 CI 확인 후 BE-08이다. BE-06은 실행 순서의 P4 판단 연결 단계에서 필요한 비동기 작업과 함께 착수한다. FE-01·QA-02도 별도 착수 가능하다. main 이외 브랜치·PR을 만들지 않는다.
