...
BASE-01–03, CORE-01–15, BE-01–03은 VERIFIED다. **CORE-16은 FE-14·FE-16과 허용된 실제 기록·holdout이 준비될 때 재개한다.** 다음 서버 카드는 BE-04다. FE-01·QA-02도 별도 착수 가능하다. main 이외 브랜치·PR을 만들지 않는다.
