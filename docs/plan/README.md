...
BASE-01–03, CORE-01–15, BE-01–10, BE-12는 VERIFIED다. **CORE-16은 FE-14·FE-16과 허용된 실제 기록·holdout이 준비될 때 재개한다.** BE-11은 FE-01→FE-02 선행 검증을 기다린다. 다음 독립 서버 카드는 BE-13이다. FE-01·QA-02도 별도 착수 가능하다. main 이외 브랜치·PR을 만들지 않는다.
