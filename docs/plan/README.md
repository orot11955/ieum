...
BASE-01–03, CORE-01–15, BE-01–02는 VERIFIED이고 BE-03은 로컬 구현·검증 후 Linux CI 대기 중이다. **CORE-16은 FE-14·FE-16과 허용된 실제 기록·holdout이 준비될 때 재개한다.** BE-03의 CI 확인 후 BE-04에 착수한다. FE-01·QA-02도 별도 착수 가능하다. main 이외 브랜치·PR을 만들지 않는다.
