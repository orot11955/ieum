...
BASE-01–03, CORE-01–15, BE-01–10, BE-12–15, FE-01은 VERIFIED다. FE-02는 구현 후 Linux 검증 중이다. **CORE-16은 FE-14·FE-16과 허용된 실제 기록·holdout이 준비될 때 재개한다.** BE-11은 FE-02 선행 검증을 기다린다. main 이외 브랜치·PR을 만들지 않는다.
