...
BASE-01–03, CORE-01–15, BE-01–03은 VERIFIED다. BE-04는 로컬 구현·PostgreSQL 검증을 마친 IMPLEMENTED 상태이며 Linux CI 확인이 남았다. **CORE-16은 FE-14·FE-16과 허용된 실제 기록·holdout이 준비될 때 재개한다.** BE-05는 BE-04 VERIFIED 뒤 착수한다. FE-01·QA-02도 별도 착수 가능하다. main 이외 브랜치·PR을 만들지 않는다.
