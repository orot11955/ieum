...
2026-09-23 KST · **main 채택 / CORE-01–09·14 검증 완료**
...
BASE-01–03과 CORE-01–09·14는 VERIFIED다. 다음은 **CORE-10**을 진행한다. CORE-12·BE-01·FE-01도 착수 가능하다. 라이브러리 호환성 spike는 카드의 선행관계가 충족될 때만 진행한다. main 이외 브랜치·PR을 만들지 않는다.
