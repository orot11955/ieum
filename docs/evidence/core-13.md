...
- 기능 커밋: `5d386e3`, 보완 `75e233b`·`2f41b25`; [최종 GitHub Actions 실행](https://github.com/orot11955/ieum/actions/runs/35868981078) `completed success` (Linux).
...
- 기능 CI 성공 뒤 diff 검토에서 새 parent를 제3 Context 아래에 붙일 때 해당 Context revision이 base set에 빠지는 점을 발견했다. CREATE_PARENT 안에서만 attach 대상의 identity/membership revision을 base set에 포함하고 테스트했다. KEEP/MERGE signature는 무관한 attach 설정에 흔들리지 않게 했다.
