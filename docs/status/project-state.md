# IEUM 프로젝트 상태 · CORE-01–15 VERIFIED, CORE-16 BLOCKED
...
- 다음 구현: **BE-01·FE-01**은 착수 가능하며 QA-02도 선행 조건을 충족한다. **CORE-16은 FE-14·FE-16과 허용된 실제 기록/holdout 부재로 BLOCKED**다.
...
| 75개 작업 카드와 렌더/정합성 검사 | BASE-01–03·CORE-01–15 VERIFIED, CORE-16 BLOCKED | BE-01·FE-01 |
