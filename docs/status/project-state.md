# IEUM 프로젝트 상태 · BE-05 VERIFIED, CORE-16 BLOCKED
...
- 진행 중: 다음 서버 카드는 **BE-06 pg-boss worker·transactional outbox**다. **CORE-16은 FE-14·FE-16과 허용된 실제 기록/holdout 부재로 BLOCKED**다.
...
| 75개 작업 카드와 렌더/정합성 검사 | BASE-01–03·CORE-01–15·BE-01–05 VERIFIED, CORE-16 BLOCKED | BE-06·FE-01 |
...
| Nest API·인증·DB·worker·업무 기능 | BE-01 최소 API·BE-02 auth adapter·BE-03 업무 DB/RLS·BE-04 계정/초대/세션/복구·BE-05 명령/receipt/감사/outbox가 Linux CI 통과. 기록·job API 미구현 | BE-06–26 |
