# IEUM 프로젝트 상태 · BE-01–16·FE-02 VERIFIED, CORE-16 BLOCKED
...
- 진행 중: BE-17 선택적 모델 정제 adapter·비용·실패 격리. **CORE-16은 FE-14·FE-16과 허용된 실제 기록/holdout 부재로 BLOCKED**다.
...
| 75개 작업 카드와 렌더/정합성 검사 | BASE-01–03·CORE-01–15·BE-01–16·FE-01–02 VERIFIED, CORE-16 BLOCKED | BE-17 |
...
| Nest API·인증·DB·worker·업무 기능 | BE-01–16 Linux CI 통과. BE-16 로컬 PostgreSQL 56/56·출처/작업실 HTTP 반례와 Linux 네 job 통과. 판단 job은 observe 모드 | BE-17–26 |
