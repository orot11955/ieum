# IEUM 프로젝트 상태 · BE-05 IMPLEMENTED, CORE-16 BLOCKED
...
- 진행 중: **BE-05 업무 명령·멱등성·감사 IMPLEMENTED**, 로컬 PostgreSQL·HTTP 반례 통과, Linux CI 확인 대기. 다음 카드는 BE-06이다. **CORE-16은 FE-14·FE-16과 허용된 실제 기록/holdout 부재로 BLOCKED**다.
...
| 75개 작업 카드와 렌더/정합성 검사 | BASE-01–03·CORE-01–15·BE-01–04 VERIFIED, BE-05 IMPLEMENTED, CORE-16 BLOCKED | BE-05 CI·BE-06·FE-01 |
...
| Nest API·인증·DB·worker·업무 기능 | BE-01 최소 API·BE-02 auth adapter·BE-03 업무 DB/RLS·BE-04 계정/초대/세션/복구가 Linux CI 통과. BE-05 명령·receipt·감사·outbox는 로컬 검증 완료. 기록·job API 미구현 | BE-05 CI, BE-06–26 |
...
BE-05의 명령·멱등성·감사·outbox 및 로컬 PostgreSQL/HTTP 반례는 [BE-05 증거](../evidence/be-05.md)에 있다. Linux CI 결과는 해당 증거에 별도로 기록한다.
