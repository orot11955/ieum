# IEUM 프로젝트 상태 · BE-02 VERIFIED, CORE-16 BLOCKED

- 검증 기준: main `e5cb093` (2026-09-24 KST, BE-02 GitHub Actions run `35883533850` 성공)
...
- 진행 중: **BE-02는 인증 adapter와 격리 PostgreSQL 시험을 Linux CI까지 통과해 VERIFIED**다 ([run 35883533850](https://github.com/orot11955/ieum/actions/runs/35883533850)). 다음은 BE-03 업무 schema/RLS다. **CORE-16은 FE-14·FE-16과 허용된 실제 기록/holdout 부재로 BLOCKED**다.
...
| 75개 작업 카드와 렌더/정합성 검사 | BASE-01–03·CORE-01–15·BE-01–02 VERIFIED, CORE-16 BLOCKED | BE-03·FE-01 |
...
| Nest API·인증·DB·worker·업무 기능 | BE-01 최소 API 및 BE-02 auth adapter/격리 DB 시험 Linux CI 통과. 업무 권한·job·업무 API 미구현 | BE-03–26 |
