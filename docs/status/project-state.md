# IEUM 프로젝트 상태 · BE-01–17·FE-02 VERIFIED, CORE-16 BLOCKED

- 검증 기준: BE-15 Linux GitHub Actions run `35921525076`, FE-01 run `36090745845`, FE-02 run `36092642869`, BE-11 run `36094399398`, BE-16 run `36096572669`, BE-17 run `36099486660` 네 job 성공(2026-09-25 KST)
- 실행 정본: [계획 1.1](../plan/README.md), [backlog](../plan/backlog.json)
- 완료 범위: **BASE-01–03, CORE-01–15, BE-01–17, FE-01–02 VERIFIED**. 원본·근거·시점 snapshot, lexical/semantic/hybrid 관찰 검색과 합성 평가, 근거 묶음, 추출 후보, 구조 진단·변경안 미리보기/승인·역변경, 문서 계획·claim 검증 계약, Nest/Fastify 조립, 실제 DB 인증·업무 workspace/RLS·계정/초대/세션/복구·명령/감사/outbox relay·원문/unit revision·다중 Context 소속과 관계·독립 Task 수명·결과 원본·일정 시간대/DST·문서 draft/revision·위키 링크·출처 묶음/작업실·선택적 모델 artifact·제품 observe 판단 job, Paper/Dark 공통 UI와 합성 편집기·폼 spike까지 확인했다.
- 진행 중: BE-18 비공개 첨부·안전 검증·공개 파생물. **CORE-16은 FE-14·FE-16과 허용된 실제 기록/holdout 부재로 BLOCKED**다.
...
| 75개 작업 카드와 렌더/정합성 검사 | BASE-01–03·CORE-01–15·BE-01–17·FE-01–02 VERIFIED, CORE-16 BLOCKED | BE-18 |
...
| Nest API·인증·DB·worker·업무 기능 | BE-01–17 Linux CI 통과. BE-17은 합성 provider·PostgreSQL 경계 검증, 실제 모델 호출 미검증. 판단 job은 observe 모드 | BE-18–26 |
