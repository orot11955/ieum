# IEUM 프로젝트 상태 · BE-03 VERIFIED, CORE-16 BLOCKED
...
- 완료 범위: **BASE-01–03, CORE-01–15, BE-01–03**. 원본·근거·시점 snapshot, lexical/semantic/hybrid 관찰 검색과 합성 평가, 근거 묶음, 추출 후보, 구조 진단·변경안 미리보기, 문서 계획·claim 검증 계약, Nest/Fastify 조립, 실제 DB 인증 adapter와 업무 workspace/RLS 기반까지 VERIFIED다.
- 진행 중: 다음 서버 카드는 **BE-04 계정·개인 공간**이다. **CORE-16은 FE-14·FE-16과 허용된 실제 기록/holdout 부재로 BLOCKED**다.
...
| 75개 작업 카드와 렌더/정합성 검사 | BASE-01–03·CORE-01–15·BE-01–03 VERIFIED, CORE-16 BLOCKED | BE-04·FE-01 |
...
| Nest API·인증·DB·worker·업무 기능 | BE-01 최소 API·BE-02 auth adapter·BE-03 업무 DB/RLS는 Linux CI 통과. 사용자 membership·업무 API·job 미구현 | BE-04–26 |
...
BE-02의 PostgreSQL·CI 시험은 [BE-02 증거](../evidence/be-02.md)와 [auth spike 보고서](../evidence/auth-spike-report.md)에 있다. BE-03의 로컬/Linux PostgreSQL·role/RLS 반례는 [BE-03 증거](../evidence/be-03.md)에 있다.
