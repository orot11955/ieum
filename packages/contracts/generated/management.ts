...
export interface operations {
    ...
    createPortableExport: {
        ...
        requestBody?: never;
        responses: {
            /** @description Capture and Unit revision history, Context, Task and Event current-state plus Task transition/result export run; expires in 24 hours */
            201: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    downloadPortableExport: {
        ...
        requestBody?: never;
        responses: {
            /** @description Private gzipped tar bundle */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    stagePortableImport: {
        ...
        requestBody: {
            content: {
                "application/vnd.ieum.bundle+gzip": string;
            };
        };
        responses: {
            /** @description Validated staged import */
            201: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    previewPortableImport: {
        ...
        requestBody?: never;
        responses: {
            /** @description Current duplicate/conflict preview */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    applyPortableImport: {
        ...
        responses: {
            /** @description Row results; partial failures retained */
            201: {
                headers: {
                    [name: string]: unknown;
                };
